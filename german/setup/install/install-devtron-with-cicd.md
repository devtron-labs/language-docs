# Devtron mit CICD installieren

In diesem Abschnitt beschreiben wir die Schritte im Detail, wie Sie Devtron mit CI/CD-Integration installieren können.

## Bevor Sie anfangen

Installieren Sie [Helm](https://helm.sh/docs/intro/install/), falls Sie es noch nicht installiert haben.

## Devtron mit CI/CD installieren

Führen Sie den folgenden Befehl aus, um die neueste Version von Devtron zusammen mit dem CI/CD-Modul zu installieren:
~~~ bash
...
**Hinweis**: Wenn Sie den Blob-Speicher während der Installation konfigurieren möchten, lesen Sie bitte [Blob-Speicher während der Installation konfigurieren](#blob-storage-während-der-installation-konfigurieren).

## Installieren Sie den AWS EBS CSI-Treiber, falls erforderlich

Wenn Sie EKS Version 1.23 oder später verwenden, müssen Sie [aws-ebs-csi-driver](https://docs.aws.amazon.com/eks/latest/userguide/ebs-csi.html) installieren.

Führen Sie den folgenden Befehl aus, um den aws ebs csi-Treiber mit Helm zu installieren:
~~~ bash
